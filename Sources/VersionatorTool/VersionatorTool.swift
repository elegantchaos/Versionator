...
@main struct VersionatorTool {
  ...
  static func writeSwift(to url: URL, version: String.SubSequence, commit: String.SubSequence, tag: String.SubSequence, buildNumber: String, gitVersion: String) {
    let generatedSwift = """
  ...
  static func writeHeader(to url: URL, version: String.SubSequence, commit: String.SubSequence, tag: String.SubSequence, buildNumber: String, gitVersion: String) {
    let generatedHeader = """
      /// This file is generated by Versionator -- DO NOT EDIT.
      /// See github.com/elegantchaos/Versionator for more info.
  ...
  static func writePlist(to url: URL, buildNumber: String, commit: String.SubSequence, gitVersion: String) {
    let info =
      [
